...
void * thread_usuario(void * arg) {
	...
	printf("El usuario %d tiene %d viajes en su BONOBUS\n" , id_usuario, num_viajes);
	pthread_mutex_lock(&mutex);//Para viajeros_con_BONOBUS
	...
	printf("El usuario %d finaliza su trayecto porque no le quedan viajes en su BONOBUS\n" , id_usuario, num_viajes);
...
void Subir_Autobus(int id_usuario, int origen){
	...
	printf("El usuario %d sube al autobus en la parada %d\n" , id_usuario, origen);
	n_ocupantes++;
	esperando_parada[origen]--;
...
void Bajar_Autobus(int id_usuario, int destino){
	...
	pthread_mutex_lock(&mutex);
	printf("El usuario %d quiere bajarse en la parada %d\n" , id_usuario, destino);
	...
	//Llega al destino
	esperando_bajar[destino]--;
	printf("El usuario %d se baja en la parada %d\n" , id_usuario, destino);
	n_ocupantes--;
