...
public class BombList {
	...
	public String characterAtToString(int i, int j) { //Devuelve el string de la bomba en la posición i,j o el caracter vacío si no hay bomba
	...
	public boolean impactaLaser(UCMShipLaser laser) { //Gestiona los impactos entre laser y bombas
	...
	private void eliminar(int i) { //Elimina la bomba i de la lista de bombas
	...
	public boolean impactaNave(UCMShip nave) { //Gestiona impactos entre bombas y una UCMShip
	...
	public void comprobarMargenes() { //Comprueba que la bomba sigue en el tablero
		int cont=this.getContador();
