...
public class BoardInitializer {
	...
	public GameObjectBoard initialize(Game game, Level level) {
		...
		initializeKamikazeAliens ();
		return board;
	}
	
	private void initializeKamikazeAliens() {
		GameObject kami1=new KamikazeAlien(this.game,level.filDestroyer(),level.colFirstDestroyer()-1,KamikazeAlien.VIDA_KAMIKAZE);
		board.add(kami1);
		GameObject kami2=new KamikazeAlien(this.game,level.filDestroyer(),level.colFirstDestroyer()+this.level.getDestroyers(),KamikazeAlien.VIDA_KAMIKAZE);
		board.add(kami2);
