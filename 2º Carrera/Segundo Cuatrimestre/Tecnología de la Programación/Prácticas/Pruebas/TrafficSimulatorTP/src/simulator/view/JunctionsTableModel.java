...
public class JunctionsTableModel extends AbstractTableModel implements TrafficSimObserver{
	...
	private String[] nombreColumnas = { "Id", "Green", "Queues","Incoming Roads","Outgoing Roads","Connections"};
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		{
			s="";
			for(Entry<Junction, Road> r:junctions.get(rowIndex).getOutRoads().entrySet())
				s+=r.getValue().getId()+"  ";
		}
			break;
		case 5:
