...
public class Junction extends SimulatedObject{
	...
	protected List<Road> listInRoads;
	private Map<Junction,Road> mapOutRoad;
	protected List<List<Vehicle>> listaColas;
	protected Map<Road,List<Vehicle>> mapaColas;
	protected int indSemaforo;
	protected int ultimPasCambSemaforo;
	protected LightSwitchingStrategy estrategiaSemaforo;
	protected DequeuingStrategy estrategiaDescolar;
	private int x;
	private int y;
