...
int main() {
	...
	cout << "Partidas ganadas por el humano: " << ganadasHumano << endl << "Partidas ganadas por la máquina : " << ganadasMaquina << endl << "Partidas en las que la máquina se pasa: ";
	cout << pasadasMaquina << endl << "Partidas en las que el humano se pasa: " << pasadasHumano << endl;
	system("pause");
	return 0;
}
