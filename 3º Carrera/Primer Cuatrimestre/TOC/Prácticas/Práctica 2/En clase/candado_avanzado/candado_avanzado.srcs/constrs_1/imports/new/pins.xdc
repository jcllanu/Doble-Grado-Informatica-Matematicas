...
set_property PACKAGE_PIN V2 [get_ports {IR[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {IR[0]}]
set_property PACKAGE_PIN T3 [get_ports {IR[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {IR[1]}]
set_property PACKAGE_PIN T2 [get_ports {IR[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {IR[2]}]
set_property PACKAGE_PIN R3 [get_ports {IR[3]}]
