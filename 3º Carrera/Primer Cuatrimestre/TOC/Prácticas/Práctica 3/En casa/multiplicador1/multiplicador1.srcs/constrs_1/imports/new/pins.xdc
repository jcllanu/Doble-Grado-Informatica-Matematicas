...
#	set_property IOSTANDARD LVCMOS33 [get_ports clk]
    ...
    set_output_delay -clock [get_clocks {sys_clk_pin}] -min -add_delay 0 [get_ports {S[*]}]
    set_output_delay -clock [get_clocks {sys_clk_pin}] -max -add_delay 0 [get_ports {S[*]}]
## Switches
...
#set_property PACKAGE_PIN E19 [get_ports {O}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {O}]
#set_property PACKAGE_PIN U19 [get_ports {O}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {O}]
#set_property PACKAGE_PIN V19 [get_ports {O}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {O}]
...
#	set_property IOSTANDARD LVCMOS33 [get_ports {O}]
#set_property PACKAGE_PIN V14 [get_ports {O}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {O}]
