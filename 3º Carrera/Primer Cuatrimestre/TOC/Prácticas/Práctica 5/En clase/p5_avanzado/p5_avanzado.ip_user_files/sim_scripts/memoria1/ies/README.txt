...
#
# Generated by export_simulation on Mon Dec 14 10:26:49 +0100 2020
#
################################################################################
...
'-reset_run' switch to the './memoria1.sh' script.

./memoria1.sh -reset_run
...
./memoria1.sh -noclean_files

For more information on the script, please type './memoria1.sh -help'.
