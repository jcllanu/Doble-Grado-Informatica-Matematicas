...
#
# Generated by export_simulation on Sun Dec 13 11:35:04 +0100 2020
#
################################################################################
...
'-reset_run' switch to the './memoria2.sh' script.

./memoria2.sh -reset_run
...
./memoria2.sh -noclean_files

For more information on the script, please type './memoria2.sh -help'.
